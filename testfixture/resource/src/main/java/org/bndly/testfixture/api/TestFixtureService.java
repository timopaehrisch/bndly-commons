...
/**
 * Service for TestFixture Delegation to the Backend Repository.
 */
public interface TestFixtureService {
	String NAME = "testFixtureService";
	
	void doEstablishTestFixture(TestFixture testFixture) throws FixtureDeploymentException;
	
	/**
	 * Gets a DBUnit FlatXmlDataSet as a String that represents the current Test Fixture.
	 * 
