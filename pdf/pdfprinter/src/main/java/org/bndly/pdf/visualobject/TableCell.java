...
public class TableCell extends Container {
	...
	public TableCell(PrintingContext context, PrintingObject owner) {
		super(context, owner);
	}
	
	@Override
	public TableCell copyToWithoutChildren(VisualObject owner) {
		TableCell copy = getContext().createTableCell(owner);
		return copyStyleClassesTo(copy);
	}

	@Override
	public TableCell copyTo(VisualObject owner) {
		TableCell copyContainer = getContext().createTableCell(owner);
