...
import org.bndly.common.service.shared.DelegatingGraphListener.DelegatingGraphListenerContext;
...
public class DelegatingGraphListener implements BeanGraphIteratorListener<DelegatingGraphListenerContext> {
	...
	public static class DelegatingGraphListenerContext {
		...
		Map<Class<? extends BeanGraphIteratorListener>, Object> contexts = new HashMap<Class<? extends BeanGraphIteratorListener>, Object>();
