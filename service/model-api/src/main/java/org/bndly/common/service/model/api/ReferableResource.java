...
public interface ReferableResource<T> extends Linkable {

	boolean isResourceReference();

	boolean isSmartReference();

	<B extends T> boolean isReferenceFor(B otherObject);

	T buildReference() throws ReferenceBuildingException;
