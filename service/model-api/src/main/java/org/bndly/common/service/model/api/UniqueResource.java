...
/**
 * Interface every Resource has to implement to abstract the Identifier away from DB generated IDs.
 * 
 * So in the end every Resource is referable by its ResourceIdentifier 
 * 
 */
public interface UniqueResource<T> {

    <B extends T> boolean exists(B object);
}
