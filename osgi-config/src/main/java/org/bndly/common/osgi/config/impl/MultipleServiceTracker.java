...
public class MultipleServiceTracker extends ServiceTracker {
	...
	private static final Logger LOG = LoggerFactory.getLogger(MultipleServiceTracker.class);
	...
	private void fireDestroy() {
		...
		if (ready) {
			...
			try {
				...
				LOG.error("failed to fire destroy event", e);
			}
		}
	}
	...
	private void fireReady() {
		...
		if (!ready) {
			...
			try {
				...
				LOG.error("failed to fire ready event", e);
			}
		}
	}
