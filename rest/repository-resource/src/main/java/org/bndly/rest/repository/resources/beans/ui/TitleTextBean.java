 ...
 */
public class TitleTextBean extends BeanWrapper implements Initializeable {

	public static final String BEAN_TYPE = "cy:titletext";
	private String title;
	private String text;
	
	public TitleTextBean(Bean wrapped) {
		super(wrapped);
	}
