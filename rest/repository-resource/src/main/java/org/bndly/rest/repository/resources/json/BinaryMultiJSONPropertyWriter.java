 ...
 */
public class BinaryMultiJSONPropertyWriter implements JSONPropertyWriter {

	private final Base64Service base64Service;

	public BinaryMultiJSONPropertyWriter(Base64Service base64Service) {
	...
	public void write(Property property, JSONWriter writer) throws RepositoryException, IOException {
		...
		if (binaries != null) {
			...
			for (InputStream binary : binaries) {
				if (!firstString) {
					writer.writeComma();
				}
				if (binary != null) {
