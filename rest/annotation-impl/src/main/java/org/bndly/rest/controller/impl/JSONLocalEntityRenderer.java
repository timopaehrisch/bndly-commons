 ...
 */
public class JSONLocalEntityRenderer implements EntityRenderer, EntityParser {

	private final Map<String,String> xmlToJsonNamespaces;

	public JSONLocalEntityRenderer(Map<String, String> xmlToJsonNamespaces) {
	...
	public Object parse(ReplayableInputStream is, Class<?> requiredType) throws IOException {
		try {
			JAXBContext ctx = JAXBContext.newInstance(requiredType);
