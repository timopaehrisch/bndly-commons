 ...
 */
public class XMLLocalContextEntityRenderer implements EntityRenderer, EntityParser {
	private static final Logger LOG = LoggerFactory.getLogger(XMLLocalContextEntityRenderer.class);
	...
	public Object parse(ReplayableInputStream is, Class<?> requiredType) throws IOException {
		try {
			JAXBContext localContext = JAXBContext.newInstance(requiredType);
