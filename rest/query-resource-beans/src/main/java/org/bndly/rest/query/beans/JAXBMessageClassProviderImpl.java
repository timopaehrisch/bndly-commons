...
public class JAXBMessageClassProviderImpl implements JAXBMessageClassProvider {
	...
	static {
		classes = new HashSet<>();
		classes.add(SchemaQueryRestBean.class);
		classes.add(SchemaQueryArgumentRestBean.class);
		classes.add(SchemaQueryArgumentListRestBean.class);
		classes.add(SchemaQueryResultRestBean.class);
	}
	@Override
