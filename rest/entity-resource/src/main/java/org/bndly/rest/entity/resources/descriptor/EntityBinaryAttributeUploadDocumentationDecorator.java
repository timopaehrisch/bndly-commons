 ...
 */
public class EntityBinaryAttributeUploadDocumentationDecorator implements DocumentationDecorator {
	...
	public DocumentationInfo decorateDocumentationInfo(DocumentationProvider.Context context, DocumentationInfo defaultDocumentationInfo) {
		...
		final List<String> consumedContentType = new ArrayList<>();
		consumedContentType.add(ct.getName());
		return new DocumentationInfoWrapper(defaultDocumentationInfo) {

			@Override
			public List<String> getConsumes() {
				return consumedContentType;
			}
