...
public class BadArgumentClientException extends ManagedClientException {
        ...
        public BadArgumentClientException(String message, RemoteCause remoteCause) {
		super(message, remoteCause);
	}

        public BadArgumentClientException(String message, RemoteCause remoteCause, String beanClazzName) {
		super(message, remoteCause);
