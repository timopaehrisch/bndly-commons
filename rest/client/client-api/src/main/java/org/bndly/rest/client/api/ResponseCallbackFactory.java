...
public interface ResponseCallbackFactory<T> {
	...
	<B> ResponseCallback<B> createTypedResponseCallback(Request request, Class<B> responseType);
	ResponseCallback<T> createStreamWritingResponseCallback(OutputStream responseOutputStream);
}
