...
public interface ListSupport<LIST, E> {
    ...
    LIST findAllLike(E prototype) throws ClientException;
    LIST readNextPage(LIST currentPage) throws ClientException;
    LIST readPreviousPage(LIST currentPage) throws ClientException;
