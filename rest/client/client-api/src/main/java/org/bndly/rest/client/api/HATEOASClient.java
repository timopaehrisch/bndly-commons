...
public interface HATEOASClient<T> {
    String LINK_CREATE = "add";
    String LINK_READ = "self";
    String LINK_UPDATE = "update";
    String LINK_DELETE = "remove";
    String LINK_NEXT = "next";
    String LINK_PREVIOUS = "previous";
    String LINK_LIST = "list";
    
    HATEOASClient<T> accept(String acceptType);
    HATEOASClient<T> contentType(String contentType);
    HATEOASClient<T> acceptLanguage(String acceptLanguage);
    HATEOASConfiguredClient<T> follow(String rel) throws MissingLinkClientException;
