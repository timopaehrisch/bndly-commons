...
public class TestExceptionThrower implements ExceptionThrower {

	@Override
    public void throwException(Object errorObject, int statusCode, String httpMethod, String url) throws ClientException {
        throw new RuntimeException("response status code was "+statusCode+" while requesting "+url+" with HTTP "+httpMethod);
    }
