 ...
 */
public class UnallowedOperationErrorExceptionThrowerStrategy implements ExceptionThrower.Strategy {

	@Override
	public void throwException(ErrorBean errorBean, ExceptionThrower.Context context) throws ClientException {
		if ("UnallowedOperationError".equals(errorBean.getName())) {
			throw new UnallowedOperationClientException("could not perform operation, because it was not allowed. remote message: " + errorBean.getMessage(), context.getCause());
		}
	}
