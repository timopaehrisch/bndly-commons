...
public class JAXBMessageClassProviderImpl implements JAXBMessageClassProvider {
	...
	static {
		classes = new HashSet<>();
		classes.add(BusinessProcessDefinition.class);
		classes.add(BusinessProcessDefinitions.class);
		classes.add(BusinessProcessInstance.class);
		classes.add(BusinessProcessInstances.class);
		classes.add(BusinessProcessVariable.class);
		classes.add(BusinessProcessVariables.class);
	}
