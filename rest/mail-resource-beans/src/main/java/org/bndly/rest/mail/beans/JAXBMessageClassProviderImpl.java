...
public class JAXBMessageClassProviderImpl implements JAXBMessageClassProvider {
	...
	static {
		classes = new HashSet<>();
		classes.add(Mail.class);
		classes.add(SimpleMailContent.class);
		classes.add(TemplateMailContent.class);
		classes.add(MailContent.class);
		classes.add(MailAttachment.class);
		classes.add(TemplateMailContent.class);
	}
