...
import org.bndly.schema.impl.CryptoProviderImpl;
...
/**
 * This is a copy of org.bndly.schema.impl.AbstractSchemaTest. There is not yet an easy approach to bootstrap an in memory engine.
...
public abstract class AbstractSchemaTest {
	...
	public void setup() {
		...
		Map<Class<? extends Attribute>, org.bndly.schema.api.AttributeMediator<?>> mediatorMap = new HashMap<>();
