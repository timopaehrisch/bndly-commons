...
public interface Engine {
    ...
    TransactionFactory getQueryRunner();
    TableRegistry getTableRegistry();
	MediatorRegistry getMediatorRegistry();
    QueryContextFactory getQueryContextFactory();
    ConstraintRegistry getConstraintRegistry();
    VirtualAttributeAdapterRegistry getVirtualAttributeAdapterRegistry();
    void reset();
