 ...
 */
public abstract class AbstractParsingState implements ParsingState {

	protected final void doContinue(Character character, Parser parser) throws QueryParsingException {
		if (character == null) {
			parser.peek().onEnd(parser);
		} else {
